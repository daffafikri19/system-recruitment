...
import { addMultipleSoal } from "@/actions/mutations/soal/verbal/addMultipleSoal"
import { deleteSoal } from "@/actions/mutations/soal/verbal/deleteSoal"
...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-verbal.xlsx";

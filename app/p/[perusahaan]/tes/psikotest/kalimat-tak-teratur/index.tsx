...
export const KalimatTakTeraturTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                ...
                max_soal={settings?.max_soal_kalimat_tak_teratur} 
                title="Tes Kalimat Tak Teratur" 
                waktu_pengerjaan={settings?.waktu_pengerjaan_kalimat_tak_teratur} />
            </CardContent>
        </Card>
    )
}
...
export const KuantitatifAnalisisTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                ...
                max_soal={settings?.max_soal_kuantitatif_analisis} 
                title="Tes Kuantitatif Analisis" 
                waktu_pengerjaan={settings?.waktu_pengerjaan_kuantitatif_analisis} />
            </CardContent>
        </Card>
    )
}
...
import { addMultipleSoal } from "@/actions/mutations/soal/penalaran-logis/addMultipleSoal"
import { deleteSoal } from "@/actions/mutations/soal/penalaran-logis/deleteSoal"
import { useLoadingContext } from "@/lib/providers/loadingStateProvider"
import { Badge } from "@/components/ui/badge"

interface dataTableProps {
    questionData: soalPenalaranLogis[]
}
...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const [pratinjau, setPratinjau] = useState<soalPenalaranLogis>({
        id: 0,
        gambar: "",
        soal: "",
        A: "",
    ...
    const handleOpenPratinjau = (data: soalPenalaranLogis) => {
        setOpenPratinjau(true);
        setPratinjau(data)
    }

    const [searchQuery, setSearchQuery] = useState("");
    const [filteredData, setFilteredData] = useState<soalPenalaranLogis[]>([]);
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-penalaran-logis.xlsx";
    ...
    return (
        <div className="w-full">
            <div className="w-full flex items-center justify-between space-x-8">
                <Button onClick={() => router.push('/dashboard/kelola-soal/penalaran-logis/add')}>Tambah Soal <Plus className="w-4 h-4 ml-2" /></Button>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex justify-center space-x-2">
                                            <Button size="icon" variant="outline" asChild>
                                                <Link href={`/dashboard/kelola-soal/penalaran-logis/edit/${question.id}/?id=${question.id}`}>

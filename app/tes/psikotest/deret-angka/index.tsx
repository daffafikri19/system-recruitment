...
export const DeretAngkaTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                <ItemSoal id_user={session?.user.id} max_soal={settings?.max_soal_deret_angka} title="Tes Deret Angka" waktu_pengerjaan={settings?.waktu_pengerjaan_deret_angka} />
            </CardContent>
        </Card>
    )
}
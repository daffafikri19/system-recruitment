...
export const PenalaranLogisTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                ...
                max_soal={settings?.max_soal_penalaran_logis} 
                title="Tes Penalaran Logis (Lawan Kata)" 
                waktu_pengerjaan={settings?.waktu_pengerjaan_penalaran_logis} />
            </CardContent>
        </Card>
    )
}
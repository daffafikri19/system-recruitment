...
import { editSoal } from '@/actions/mutations/soal/ketelitian/editSoal'
...
const EditSoalKetelitanPage = () => {
  const [media, setMedia] = useState<string | null>("");
  const [soal, setSoal] = useState("");
  const router = useRouter();
  const [question, setQuestion] = useState<SoalKetelitanProps>({
    id: 0,
    gambar: "",
    soal: "",
    kunci_jawaban: "",
        ...
        <CardContent className='py-4'>
          <form action={async formdata => {
            ...
            <div className='mt-10 w-full flex items-center justify-end space-x-4'>
              <Button type='button' variant="destructive" onClick={() => router.push('/dashboard/kelola-soal/ketelian')}>Batal</Button>
...
export default EditSoalKetelitanPage
...
import { addSingleSoal } from '@/actions/mutations/soal/kalimat-tak-teratur/addSingleSoal'
...
const AddSoalKalimatTakTeraturPage = () => {
...
export default AddSoalKalimatTakTeraturPage
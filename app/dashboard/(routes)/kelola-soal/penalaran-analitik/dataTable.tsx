...
import { addMultipleSoal } from "@/actions/mutations/soal/penalaran-analitik/addMultipleSoal"
import { deleteSoal } from "@/actions/mutations/soal/penalaran-analitik/deleteSoal"
import { useLoadingContext } from "@/lib/providers/loadingStateProvider"
import { Badge } from "@/components/ui/badge"

interface dataTableProps {
    questionData: soalPenalaranAnalitik[]
}
...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const [pratinjau, setPratinjau] = useState<soalPenalaranAnalitik>({
        id: 0,
        gambar: "",
        soal: "",
        A: "",
    ...
    const handleOpenPratinjau = (data: soalPenalaranAnalitik) => {
        setOpenPratinjau(true);
        setPratinjau(data)
    }

    const [searchQuery, setSearchQuery] = useState("");
    const [filteredData, setFilteredData] = useState<soalPenalaranAnalitik[]>([]);
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-penalaran-analitik.xlsx";
    ...
    return (
        <div className="w-full">
            <div className="w-full flex items-center justify-between space-x-8">
                <Button onClick={() => router.push('/dashboard/kelola-soal/penalaran-analitik/add')}>Tambah Soal <Plus className="w-4 h-4 ml-2" /></Button>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex justify-center space-x-2">
                                            <Button size="icon" variant="outline" asChild>
                                                <Link href={`/dashboard/kelola-soal/penalaran-analitik/edit/${question.id}/?id=${question.id}`}>

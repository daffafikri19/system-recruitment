...
import { addSingleSoal } from '@/actions/mutations/soal/kemampuan-teknikal/addSingleSoal'
...
const AddSoalKemampuanTeknikalPage = () => {
...
export default AddSoalKemampuanTeknikalPage
...
export const HitungCepatTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                <ItemSoal id_user={session?.user.id} max_soal={settings?.max_soal_hitung_cepat} title="Tes Hitung Cepat" waktu_pengerjaan={settings?.waktu_pengerjaan_hitung_cepat} />
            </CardContent>
        </Card>
    )
}
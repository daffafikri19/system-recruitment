...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const [filteredData, setFilteredData] = useState<soalAntonimSinonim[]>([]);
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-antonim-sinonim.xlsx";
    ...
    return (
        <div className="w-full">
            <div className="w-full flex items-center justify-between space-x-8">
                <Button onClick={() => router.push('/dashboard/kelola-soal/antonim-sinonim/add')}>Tambah Soal <Plus className="w-4 h-4 ml-2" /></Button>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex justify-center space-x-2">
                                            <Button size="icon" variant="outline" asChild>
                                                <Link href={`/dashboard/kelola-soal/antonim-sinonim/edit/${question.id}/?id=${question.id}`}>

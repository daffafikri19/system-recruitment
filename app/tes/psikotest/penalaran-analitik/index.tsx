...
export const PenalaranAnalitikTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                ...
                max_soal={settings?.max_soal_penalaran_analitik} 
                title="Tes Penalaran Analitik" 
                waktu_pengerjaan={settings?.waktu_pengerjaan_penalaran_analitik} />
            </CardContent>
        </Card>
    )
}
...
export const SinonimTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                <ItemSoal id_user={session?.user.id} max_soal={settings?.max_soal_sinonim} title="Tes Sinonim (Persamaan Kata)" waktu_pengerjaan={settings?.waktu_pengerjaan_sinonim} />
            </CardContent>
        </Card>
    )
}
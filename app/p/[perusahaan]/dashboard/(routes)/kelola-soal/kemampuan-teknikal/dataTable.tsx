...
import { addMultipleSoal } from "@/actions/mutations/soal/kemampuan-teknikal/addMultipleSoal"
import { deleteSoal } from "@/actions/mutations/soal/kemampuan-teknikal/deleteSoal"
import { useLoadingContext } from "@/lib/providers/loadingStateProvider"
import { Badge } from "@/components/ui/badge"

interface dataTableProps {
    questionData: soalKemampuanTeknikal[]
}
...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const [pratinjau, setPratinjau] = useState<soalKemampuanTeknikal>({
        id: 0,
        gambar: "",
        soal: "",
        A: "",
    ...
    const handleOpenPratinjau = (data: soalKemampuanTeknikal) => {
        setOpenPratinjau(true);
        setPratinjau(data)
    }

    const [searchQuery, setSearchQuery] = useState("");
    const [filteredData, setFilteredData] = useState<soalKemampuanTeknikal[]>([]);
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-kemampuan-teknikal.xlsx";
    ...
    return (
        <div className="w-full">
            <div className="w-full flex items-center justify-between space-x-8">
                <Button onClick={() => router.push('/dashboard/kelola-soal/kemampuan-teknikal/add')}>Tambah Soal <Plus className="w-4 h-4 ml-2" /></Button>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex justify-center space-x-2">
                                            <Button size="icon" variant="outline" asChild>
                                                <Link href={`/dashboard/kelola-soal/kemampuan-teknikal/edit/${question.id}/?id=${question.id}`}>

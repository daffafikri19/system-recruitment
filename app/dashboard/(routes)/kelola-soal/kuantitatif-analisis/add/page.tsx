...
import { addSingleSoal } from '@/actions/mutations/soal/kuantitatif-analisis/addSingleSoal'
...
const AddSoalKuantitatifAnalisisPage = () => {
...
export default AddSoalKuantitatifAnalisisPage
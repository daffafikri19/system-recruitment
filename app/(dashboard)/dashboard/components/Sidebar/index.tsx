...
import { ArrowLeft, ChevronDown, ContactIcon, LayoutDashboardIcon, ListChecksIcon, ListTodoIcon, PercentSquareIcon, Users2Icon } from "lucide-react";
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/dashboard/tes/?tes=1"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.endsWith("tes") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/dashboard/kelola-soal/tpa"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 text-sm truncate font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/dashboard/kelola-soal/tpa" && "text-white"
                                }`}
                            >
                          ...
                          <li>
                            <Link
                              href="/dashboard/kelola-soal/tkb"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 text-sm truncate font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/dashboard/kelola-soal/tkb" && "text-white"
                                }`}
                            >
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname.endsWith("/laporan") || pathname.endsWith("/laporan")) &&
                          "bg-graydark dark:bg-meta-4"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/dashboard/laporan/hasil-papi"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 text-sm truncate font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/dashboard/laporan/hasil-papi" && "text-white"
                                }`}
                            >
                              Hasil Psikotest PAPI
                            </Link>
                          </li>
                          <li>
                            <Link
                              href="/dashboard/laporan/hasil-disc"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 text-sm truncate font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/dashboard/laporan/hasil-disc" && "text-white"
                                }`}
                            >
                              Hasil Psikotest DISC
                            </Link>
                          </li>
                        </ul>
                      </div>

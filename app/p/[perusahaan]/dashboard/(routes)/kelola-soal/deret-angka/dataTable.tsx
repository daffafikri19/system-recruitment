...
import { addMultipleSoal } from "@/actions/mutations/soal/deret-angka/addMultipleSoal"
import { deleteSoal } from "@/actions/mutations/soal/deret-angka/deleteSoal"
import { useLoadingContext } from "@/lib/providers/loadingStateProvider"
import { Badge } from "@/components/ui/badge"

interface dataTableProps {
    questionData: soalDeret[]
}
...
export const DataTable = ({ questionData }: dataTableProps) => {
    ...
    const [pratinjau, setPratinjau] = useState<soalDeret>({
        id: 0,
        gambar: "",
        soal: "",
        A: "",
    ...
    const handleOpenPratinjau = (data: soalDeret) => {
        setOpenPratinjau(true);
        setPratinjau(data)
    }

    const [searchQuery, setSearchQuery] = useState("");
    const [filteredData, setFilteredData] = useState<soalDeret[]>([]);
    ...
    const handleDownloadTemplate = () => {
        const templateURL = "/file/template-soal-deret.xlsx";
    ...
    return (
        <div className="w-full">
            <div className="w-full flex items-center justify-between space-x-8">
                <Button onClick={() => router.push('/dashboard/kelola-soal/deret-angka/add')}>Tambah Soal <Plus className="w-4 h-4 ml-2" /></Button>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex justify-center space-x-2">
                                            <Button size="icon" variant="outline" asChild>
                                                <Link href={`/dashboard/kelola-soal/deret-angka/edit/${question.id}/?id=${question.id}`}>

...
import { addSingleSoal } from '@/actions/mutations/soal/informasi-singkat/addSingleSoal'
...
const AddSoalInformasiSingkatPage = () => {
                        ...
                        <div className='mt-5'>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                                <div>
                                    ...
                                    <Textarea required name='kunci_jawaban' />
                                </div>
                                <div>
                                    <Label>Bahasa</Label>
...
export default AddSoalInformasiSingkatPage
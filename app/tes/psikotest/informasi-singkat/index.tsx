...
export const InformasiSingkatTes = () => {
    ...
    return (
        <Card>
            <CardContent>
                <ItemSoal id_user={session?.user.id} max_soal={settings?.max_soal_informasi_singkat} title="Tes Informasi Singkat" waktu_pengerjaan={settings?.waktu_pengerjaan_informasi_singkat} />
            </CardContent>
        </Card>
    )
}
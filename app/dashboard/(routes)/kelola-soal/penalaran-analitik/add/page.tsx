...
import { addSingleSoal } from '@/actions/mutations/soal/penalaran-analitik/addSingleSoal'
...
const AddSoalPenalaranAnalitikPage = () => {
...
export default AddSoalPenalaranAnalitikPage